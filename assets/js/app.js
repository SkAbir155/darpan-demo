...
(function () {
  ...
  const I18N = {
    bn: {
      ...
      // Free AI try-on (IDM-VTON)
      'ai.free': 'ফ্রি AI · সাইন-আপ লাগবে না',
      'ai.clothingOnly': 'AI ট্রাই-অন এখন শুধু পোশাকের জন্য — জুতা ও চশমায় নমুনা ফলাফল দেখানো হবে।',
      'proc.connecting': 'AI-এর সাথে সংযোগ হচ্ছে...',
      'proc.queue': 'লাইনে অপেক্ষা — আপনার আগে {n} জন',
      'proc.processing': 'AI আপনার ছবিতে পোশাকটি বসাচ্ছে...',
      'proc.eta': 'আনুমানিক আর {n} সেকেন্ড',
      'proc.almost': 'প্রায় শেষ...',
      'proc.hint': 'সাধারণত ২০–৬০ সেকেন্ড লাগে',
      'proc.cancel': 'বাতিল করুন',
      'proc.step1': 'ছবি',
      'proc.step2': 'সংযোগ',
      'proc.step3': 'AI',
      'res.aiReal': 'AI দ্বারা তৈরি',
      'res.noteReal': 'AI দিয়ে তৈরি ছবি — আসল রং ও মাপ সামান্য ভিন্ন হতে পারে।',
      'res.fallback': 'ফ্রি AI এই মুহূর্তে ব্যস্ত, তাই নমুনা ফলাফল দেখানো হলো।',
      'res.retryAi': 'AI দিয়ে আবার চেষ্টা',
    ...
    en: {
      ...
      'ai.free': 'Free AI · no sign-up',
      'ai.clothingOnly': 'AI try-on works for clothing only for now — shoes and glasses show a sample result.',
      'proc.connecting': 'Connecting to the AI...',
      'proc.queue': 'In queue — {n} ahead of you',
      'proc.processing': 'AI is fitting the outfit to your photo...',
      'proc.eta': 'About {n} seconds left',
      'proc.almost': 'Almost done...',
      'proc.hint': 'Usually takes 20–60 seconds',
      'proc.cancel': 'Cancel',
      'proc.step1': 'Photo',
      'proc.step2': 'Connect',
      'proc.step3': 'AI',
      'res.aiReal': 'AI generated',
      'res.noteReal': 'AI-generated image — actual colour and fit may vary slightly.',
      'res.fallback': 'The free AI is busy right now, so a sample result is shown.',
      'res.retryAi': 'Try again with AI',
