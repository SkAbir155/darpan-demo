...
(function () {
  ...
  const I18N = {
    bn: {
      ...
      'common.demo': 'ডেমো',
      'nav.guide': 'ব্যবহার নির্দেশিকা',
      'nav.guideShort': 'নির্দেশিকা',

      // AI (FASHN) settings + processing
      'ai.settings': 'AI সেটিংস',
      'ai.title': 'FASHN AI সংযোগ',
      'ai.sub': 'ছবিতে আসল AI ট্রাই-অন চালাতে আপনার FASHN API key দিন। key শুধু এই ব্রাউজারেই সংরক্ষিত থাকবে — কোডে বা GitHub-এ যাবে না।',
      'ai.keyLabel': 'FASHN API key',
      'ai.getKey': 'app.fashn.ai → Developer API → Create new API key',
      'ai.advanced': 'অ্যাডভান্সড: প্রক্সি URL (ঐচ্ছিক)',
      'ai.proxyHint': 'নিজের রিলে সার্ভার (যেমন Cloudflare Worker) থাকলে এখানে দিন — তখন key লাগবে না।',
      'ai.save': 'সংরক্ষণ করুন',
      'ai.clear': 'মুছে ফেলুন',
      'ai.saved': 'AI সেটিংস সংরক্ষিত হয়েছে',
      'ai.cleared': 'AI key মুছে ফেলা হয়েছে',
      'ai.warn': 'শেয়ার করা কম্পিউটারে key সংরক্ষণ করবেন না।',
      'ai.close': 'বন্ধ করুন',
      'ai.on': 'AI চালু',
      'ai.off': 'ডেমো মোড',
      'ai.needKey': 'আসল AI ট্রাই-অনের জন্য FASHN API key দরকার। key না থাকলে ডেমো ফলাফল দেখানো হবে।',
      'ai.useDemo': 'ডেমো ফলাফল দেখুন',
      'ai.addKey': 'API key দিন',
      'ai.clothingOnly': 'AI ট্রাই-অন এখন শুধু পোশাকের জন্য — জুতা ও চশমায় ডেমো ফলাফল দেখানো হবে।',
      'proc.preparing': 'ছবি প্রস্তুত হচ্ছে...',
      'proc.uploading': 'AI সার্ভারে পাঠানো হচ্ছে...',
      'proc.queue': 'লাইনে অপেক্ষা করছে...',
      'proc.processing': 'AI আপনার ছবিতে পোশাকটি বসাচ্ছে...',
      'proc.demo': 'ডেমো ফলাফল তৈরি হচ্ছে...',
      'proc.hint': 'সাধারণত ১৫–৪০ সেকেন্ড লাগে',
      'proc.failed': 'দুঃখিত, ট্রাই-অন করা যায়নি',
      'proc.timeout': 'অনেক সময় লাগছে। একটু পরে আবার চেষ্টা করুন।',
      'proc.badFile': 'অনুগ্রহ করে একটি ছবি (JPG বা PNG) বেছে নিন।',
      'proc.authError': 'API key সঠিক নয় বা ক্রেডিট শেষ। AI সেটিংস দেখুন।',
      'proc.retry': 'আবার চেষ্টা করুন',
      'prod.cameraSoon': 'শিগগির আসছে',
      'res.aiReal': 'FASHN AI দ্বারা তৈরি',
      'res.demoBadge': 'ডেমো ফলাফল',
      'res.noteReal': 'AI দিয়ে তৈরি ছবি — আসল রং ও মাপ সামান্য ভিন্ন হতে পারে।',
      'res.downloadFail': 'ছবিটি নতুন ট্যাবে খোলা হয়েছে — সেখান থেকে সেভ করুন।',
      'cat.all': 'সব',
      'cat.clothing': 'পোশাক',
      'cat.shoes': 'জুতা',
      'cat.glasses': 'চশমা',
    ...
    en: {
      ...
      'ai.title': 'Connect FASHN AI',
      'ai.sub': 'Paste your FASHN API key to run real AI try-ons. The key is stored only in this browser — never in the code or on GitHub.',
      'ai.keyLabel': 'FASHN API key',
      'ai.getKey': 'app.fashn.ai → Developer API → Create new API key',
      'ai.advanced': 'Advanced: proxy URL (optional)',
      'ai.proxyHint': 'If you run your own relay (e.g. a Cloudflare Worker), enter it here — no key needed then.',
      'ai.save': 'Save',
      'ai.clear': 'Remove',
      'ai.saved': 'AI settings saved',
      'ai.cleared': 'AI key removed',
      'ai.warn': 'Don’t save your key on a shared computer.',
      'ai.close': 'Close',
      'ai.on': 'AI on',
      'ai.off': 'Demo mode',
      'ai.needKey': 'Real AI try-on needs a FASHN API key. Without one, a demo result is shown.',
      'ai.useDemo': 'See demo result',
      'ai.addKey': 'Add API key',
      'ai.clothingOnly': 'AI try-on currently works for clothing only — shoes and glasses show a demo result.',
      'proc.preparing': 'Preparing your photo...',
      'proc.uploading': 'Sending to the AI server...',
      'proc.queue': 'Waiting in queue...',
      'proc.processing': 'AI is fitting the outfit to your photo...',
      'proc.demo': 'Building a demo result...',
      'proc.hint': 'Usually takes 15–40 seconds',
      'proc.failed': 'Sorry, the try-on failed',
      'proc.timeout': 'This is taking too long. Please try again shortly.',
      'proc.badFile': 'Please choose an image (JPG or PNG).',
      'proc.authError': 'The API key is wrong or out of credits. Check AI settings.',
      'proc.retry': 'Try again',
      'prod.cameraSoon': 'Coming soon',
      'res.aiReal': 'Generated by FASHN AI',
      'res.demoBadge': 'Demo result',
      'res.noteReal': 'AI-generated image — actual colour and fit may vary slightly.',
      'res.downloadFail': 'The image opened in a new tab — save it from there.',
      'cat.all': 'All',
  ...
  // "How to use" link: icon on phones, icon + label on tablets / computers.
  function guideLink() {
    return '<a href="guide.html" class="flex items-center gap-1.5 rounded-full px-2 py-1.5 text-sm font-semibold text-navy hover:bg-navy-50" aria-label="' + t('nav.guide') + '">' +
      icon('book', 'h-5 w-5') + '<span class="hidden md:inline">' + t('nav.guide') + '</span></a>';
  }
  ...
  function renderHeader() {
    ...
    const base = 'sticky top-0 z-30 flex h-14 items-center justify-between gap-2 border-b border-slate-100 bg-white/95 wrap backdrop-blur';
    el.className = base;
    ...
    if (variant === 'main') {
      el.innerHTML =
        wordmark() +
        '<div class="flex items-center gap-1 md:gap-2">' + guideLink() + langToggle() +
      ...
      el.innerHTML =
        '<div class="flex items-center gap-1">' + backBtn + wordmark('text-[22px]') + '</div>' +
        '<div class="flex items-center gap-1 md:gap-2">' + guideLink() + langToggle() + '</div>';
      ...
      el.className = 'wrap flex h-14 items-center justify-between gap-2';
      el.innerHTML =
        wordmark('text-[22px]') +
      ...
      el.className = 'wrap absolute inset-x-0 top-0 z-30 flex h-14 items-center justify-end';
  ...
  function renderBottomNav() {
    ...
    const items = [
      ...
      { id: 'guide', href: 'guide.html', icon: 'book', label: 'nav.guideShort' }
    ];
    el.className = 'fixed bottom-0 left-1/2 z-30 w-full max-w-md -translate-x-1/2 border-t border-slate-100 bg-white/95 backdrop-blur md:bottom-4 md:rounded-2xl md:border md:shadow-lift';
    el.innerHTML =
      '<div class="grid grid-cols-5 px-1 pb-[max(env(safe-area-inset-bottom),6px)] pt-1.5">' +
      items.map((it) => {
        ...
        return '<a href="' + it.href + '" class="flex flex-col items-center gap-0.5 rounded-xl py-1.5 text-[11px] font-medium ' +
          ...
          '<span class="flex h-7 w-11 items-center justify-center rounded-full ' + (on ? 'bg-navy-50' : '') + '">' + icon(it.icon, 'w-[22px] h-[22px]') + '</span>' +
          t(it.label) + '</a>';
      }).join('') +
      '</div>';
  }
  ...
  function renderContact() {
    ...
    const row = (href, iconName, label, value) =>
      ...
      '</a>';
    el.innerHTML =
      '<div class="h-full rounded-3xl bg-navy p-5 text-white shadow-lift md:p-8">' +
